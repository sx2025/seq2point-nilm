...
test_directory="G:/seq2point-nilm/dataset_management/refit/kettle/kettle_training_.csv"
...
parser.add_argument("--crop", type=int, default="300000", help="The number of rows of the dataset to take training data from. Default is 10000. ")
parser.add_argument("--algorithm", type=remove_space, default="default", help="The pruning algorithm of the model to test. Default is none. ")
parser.add_argument("--network_type", type=remove_space, default="default", help="The seq2point architecture to use. Only use if you do not want to use the standard architecture. Available are: default, dropout, reduced, and reduced_dropout. ")
...
saved_model_dir = "saved_models/" + arguments.appliance_name + "_" + "_model.h5"
