...
training_directory="G:/seq2point-nilm/dataset_management/ukdale/washingmachine/washingmachine_training_.csv"
validation_directory="G:/seq2point-nilm/dataset_management/ukdale/washingmachine/washingmachine_validation_.csv"

parser = argparse.ArgumentParser(description="Train sequence-to-point learning for energy disaggregation. ")

parser.add_argument("--appliance_name", type=remove_space, default="washingmachine", help="The name of the appliance to train the network with. Default is kettle. Available are: kettle, fridge, washingmachine, dishwasher, and microwave. ")
...
parser.add_argument("--pruning_algorithm", type=remove_space, default="spp", help="The pruning algorithm that the network will train with. Default is none. Available are: spp, entropic, threshold. ")
parser.add_argument("--network_type", type=remove_space, default="", help="The seq2point architecture to use. ")
parser.add_argument("--epochs", type=int, default="10", help="Number of epochs. Default is 10. ")
parser.add_argument("--input_window_length", type=int, default="999", help="Number of input data points to network. Default is 599.")
